...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
        ...
        question_vec = question_to_vec(question = question, embeddings = self.word_embeddings,
                                        dim = self.embeddings_dim) #### YOUR CODE HERE ####
...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        self.chitchat_bot = ChatBot('felixdae', trainer = 'chatterbot.trainers.ChatterBotCorpusTrainer')
